...
*   **🧠 Mehrdimensionale Suchintent-Klassifizierung:** Erkennt die Suchintention (`KNOW`, `DO`, `regional:CITY`, `regional:COUNTRY`) getrennt von den Themen-Clustern, voll optimiert für deutsche und englische Keywords. Inklusive Diagrammen zur Intent-Verteilung.
